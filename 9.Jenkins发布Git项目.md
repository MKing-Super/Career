...
echo "Application started. Logs: /root/logs/eureka-server.log"
```
...
echo "Application started. Logs: /root/logs/api-gateway.log"
```
...
echo "Application started. Logs: /root/logs/work-service.log"
```
...
echo "Application started. Logs: /root/logs/work-admin.log"
```
